class Chamado < ActiveRecord::Base
  attr_accessible :descricao, :titulo, :status, :user_id, :type_id, :sala, :predio, :tecnico, :patrimonio, :obs, :departamento

  belongs_to :user
  belongs_to :usuario
  has_many :comentarios,   dependent: :destroy

  validates_presence_of :departamento, message:  "Escolha yn departamento"
